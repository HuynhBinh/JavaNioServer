...
public class SocketProcessor implements Runnable
{
    ...
    public SocketProcessor(MessageBuffer readMessageBuffer, MessageBuffer writeMessageBuffer, IMessageReaderFactory messageReaderFactory, IMessageProcessor messageProcessor) throws IOException
    {
	...
	{
        Socket newSocket = Application.socketQueue.poll();

        while(newSocket != null)
		{
            newSocket.socketId = Application.NextSocketId.incrementAndGet();
            ...
            newSocket = Application.socketQueue.poll();
        }
    }
    ...
    /*private void printData( Message message)
    {
        System.out.print( message.socketId + " : ");
        System.out.print( message.sharedArray.toString() + " : ");
        System.out.print( message.sharedArray.length);
        *//*for(int i = 0 ; i < message.sharedArray.length; i++)
        {
            System.out.print(message.sharedArray[i]);
        }*//*
        System.out.println();
    }*/
